  ...
  return (
    <section className="py-20 bg-background border-t border-white/5">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-muted-foreground text-sm leading-relaxed">
          <div>
            <h3 className="text-lg font-semibold text-white mb-4">What is a Gigolo Job in India?</h3>
            <p className="mb-4">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white mb-4">How Much Can a Gigolo Earn in India?</h3>
            <p className="mb-4">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white mb-4">Why Divorced & Lonely Women Seek Gigolos</h3>
            <p className="mb-4">
